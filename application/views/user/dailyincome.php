                            ...
                            <div class="card mb-5 mb-xl-8">
                                ...
                                <div class="card-header border-0 pt-5">
                                    <h3 class="card-title align-items-start flex-column">
                                        ...
                                        <span class="text-muted mt-1 fw-semibold fs-7">Over 1 </span>
                                    </h3>
                                        ...
                                        <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                                            ...
                                            <thead>
                                                <tr class="fw-bold text-muted">
                                                    ...
                                                    <th class="min-w-140px">Transection Details</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#" class="text-dark fw-bold text-hover-primary fs-6">1</a>
                                                    </td>

                                                    <td>
                                                        <a href="#" class="text-dark fw-bold text-hover-primary d-block mb-1 fs-6">Amount Added from Admin</a>
                                                        <!-- <span class="text-muted fw-semibold text-muted d-block fs-7">Code: PH</span> -->
                                                    </td>

                                                    <td>
                                                        <a href="#" class="text-dark fw-bold text-hover-primary d-block mb-1 fs-6">55.00</a>
