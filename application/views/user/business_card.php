                                       ...
                                       <div id="id-card">
                                          <div class="id-card material-ui-shadow">
                                             ...
                                             <div class="id-card__logo logo">
                                                  <img alt="Logo" src="<?= base_url() ?>assets/img/logo.png" class="h-40px">
                                             ...
                                             <div class="id-card__details">
                                                ...
                                                <div class="id-card__detail">
                                                   ...
                                                   <span class="id-card__detail-value" id="id-card-date-of-birth"><?= $user_data['dateofbirth'] ?></span>
                                                </div>
                                                <div class="id-card__detail">
                                             ...
                                             <div class="id-card__details id-card__details--short">
                                                <div class="id-card__detail">
                                                   ...
                                                   <span class="id-card__detail-value" id="id-card-gender"><?= isset($user_data['gender']) ? $user_data['gender'] : '' ?>
