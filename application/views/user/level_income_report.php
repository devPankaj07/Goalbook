...
<head>
    <title> Level Bonus || Dashboard</title>
                            ...
                            <div class="card mb-5 mb-xl-8">
                                ...
                                <div class="card-header border-0 pt-5">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bold fs-3 mb-1">Level Bonus</span>
                                        ...
                                        <table class="table table-clrs table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="table">
                                            ...
                                            <thead>
                                                <tr class="fw-bold text-muted">
                                                    ...
                                                    <th class="min-w-150px">TDS Charges (5%)</th>
                                                    <th class="min-w-150px">Service Charges (5%)</th>
