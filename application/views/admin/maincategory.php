...
<head>
    ...
    <title>Main-Category || Admin</title>
                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold fs-3 mb-1">Main Category</span>
                                ...
                                <tbody id="tableBody">
                                   ...
                                   // exit;
                                    ...
                                    ?>
                                                ...
                                                <td><?= $sr ?></td>
                                                <td> <?php if (!empty($value['ph_image'])) { ?>
                                             <div class="uploaded-img">
                                             <img src="<?= base_url('assets/uploads/categoryimage/' . $value['ph_image']) ?>" alt="Profile Image" style="width: 50px;height: 50px;">
                                             </div>
                                          <?php } else { ?>
                                            <div class="uploaded-img">
                                    ...
                                    <button type="button" class="btn btn-sm btn-primary update-btn"
                                       ...
                                       >Update</button>
                                     <button class="btn btn-sm btn-danger" onclick="deleteMainCar(<?= $value['id']; ?>)">Delete</button>
                                 </td>
         ...
         <div class="modal fade" id="addnewModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
               <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <form action="add_main_cat" method="post" id="addcatForm" enctype="multipart/form-data">
                        ...
                        <div class="fv-row mb-3">
                                          ...
                                          <div class="input-box  ">
                                             ...
                                             <input type="file" class="form-file form-control" name="ph_image" id="ph_image" <?= !empty($user_data['ph_image']) ? 'disabled' : '' ?> onchange="upload()" onload="addphoto(e)">
                                        </div>
                        </div>
         ...
         <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
               <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <form action="#" method="post" id="addcatForm">
                        <!-- Your form fields here -->
   ...
   function addphoto(e) {
      ...
      $('#addcatForm').submit(function(e) {
         ...
         console.log(formData)
            ...
            $.ajax({
            url: baseurl + 'Admin/add_main_cat', // URL to submit the form data
            ...
            success: function(response) {
               ...
               if (jsonData.status === 'error') {
                  ...
                  Swal.fire(
                     ...
                     window.location.href = baseurl + 'Admin/maincategory';
                  });
