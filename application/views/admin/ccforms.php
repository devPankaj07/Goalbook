...
<head>
    ...
    <title>Category Form || Admin</title>
...
<body>
                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold fs-3 mb-1">Category Form</span>
                                ...
                                <thead>
                                    <tr class="fw-bold text-muted">
                                        ...
                                        <th class="min-w-80px">Child-Category Name</th>
                                          <th class="min-w-80px">Form Questions</th>
            ...
            <div class="modal-dialog modal-dialog-centered">
               <div class="modal-content">
                  <div class="modal-header">
                     <h5 class="modal-title" id="exampleModalLabel"><b>Add New Category Form</b></h5>
                     <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body">
                 <form action="add_form_cat" method="post" id="addformcatForm" enctype="multipart/form-data">
                            ...
                            <div class="fv-row mb-3">
                                <label class="fs-6 fw-semibold form-label" for="childid">
                                    <span class="required">Child Category:</span>
                                </label>
                                <select class="form-control form-control-solid" id="childid" name="childid">
                                    <option value=""></option>
                                    <?php foreach ($childcat_data as $row): ?>
                                        <option value="<?= $row['childid']; ?>"><?= $row['childname']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="fv-row mb-3">
                                <label class="fs-6 fw-semibold form-label" for="questions">
                                    <span class="required">Questions:</span>
                                </label>
                                <input class="form-control form-control-solid" type="text" id="questions" name="questions[]">
                            </div>
                            <div id="additionalInputs">
                                <!-- Dynamic input fields for questions will be added here -->
                            </div>
                            <button type="button" class="btn btn-primary" id="addInputButton">Add Question</button>
 ...
 <script>
   ...
   function addphoto(e) {
      ...
      $('#addformcatForm').submit(function(e) {
         ...
         console.log(formData)
            ...
            $.ajax({
            url: baseurl + 'Admin/add_form_cat', // URL to submit the form data
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        addInputButton.addEventListener("click", function () {
            ...
            newInput.classList.add("fv-row", "mb-3");
            newInput.innerHTML = `
                <label class="fs-6 fw-semibold form-label" for="questions[${inputCounter}]">
                    <span class="required">Question:</span>
                </label>
                <input class="form-control form-control-solid" type="text" id="questions[${inputCounter}]" name="questions[${inputCounter}]">
            `;
