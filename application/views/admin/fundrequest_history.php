               ...
               <div class="card mb-5 mb-xl-8">
                  ...
                  <div class="card-header border-0 pt-5">
                     <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bold fs-3 mb-1">Fund Requested History</span>
                            ...
                            //   print_r($user_data);
                              ...
                              foreach ($fundrequest as $value) {
                               ...
                               <?php if ($value->status == 'Pending') {
                                echo '<td> <span class="badge badge-light-danger">' . $value->status . '</span></td>';
                               }else{
                                echo '<td> <span class="badge badge-light-success">' . $value->status . '</span></td>';
                               }?>
