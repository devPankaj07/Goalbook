                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold fs-3 mb-1">Sub Category</span>
                                ...
                                <tbody id="tableBody">
                                   ...
                                   // exit;
                                    ...
                                    ?>
                                                ...
                                                <td><?= $sr ?></td>
                                                <td> <?php if (!empty($value['sub_image'])) { ?>
                                             <div class="uploaded-img">
                                             <img src="<?= base_url('assets/uploads/categoryimage/' . $value['sub_image']) ?>" alt="Profile Image" style="width: 50px;height: 50px;">
                                             </div>
                                          <?php } else { ?>
                                            <div class="uploaded-img">
            ...
            <div class="modal-dialog modal-dialog-centered">
               <div class="modal-content">
                  <div class="modal-header">
                     <h5 class="modal-title" id="exampleModalLabel"><b>Add New Sub-Category</b></h5>
                     <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body">
                     <form action="add_sub_cat" method="post" id="addsubcatForm" enctype="multipart/form-data">
                    ...
                    <div class="fv-row mb-3">
                           <label class="fs-6 fw-semibold form-label" for="subname">
                           <span class="required">Name:</span>
                           </label>
                           <input class="form-control form-control-solid" type="text" id="subname" name="subname">
                        ...
                        <div class="fv-row mb-3">
                                          ...
                                          <div class="input-box  ">
                                             ...
                                             <input type="file" class="form-file form-control" name="sub_image" id="sub_image" <?= !empty($user_data['sub_image']) ? 'disabled' : '' ?> onchange="upload()" onload="addphoto(e)">
                                        </div>
                        </div>
   ...
   function addphoto(e) {
      ...
      $('#addsubcatForm').submit(function(e) {
         ...
         console.log(formData)
            ...
            $.ajax({
            url: baseurl + 'Admin/add_sub_cat', // URL to submit the form data
